...
namespace Domain.Model
{
    public class Persona
    {
        ...
        public DateTime Fecha_nac { get; private set; }
        ...
        public Persona(int id, string nombre, string apellido,string direccion, string email, string telefono ,DateTime fecha_nac ,string legajo , string tipo_persona ,int id_plan)
        {
            SetId(id);
            SetNombre(nombre);
        ...
        public void SetFecha_nac(DateTime fecha_nac)
